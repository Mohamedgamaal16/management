...
import 'package:management/screens/signup_screen.dart';
import 'package:management/service/auth.dart';

// Updated SignInScreen with Firebase authentication
...
// Updated SignInForm with Firebase authentication
...
class _SignInFormState extends State<SignInForm> with FormValidationMixin {
...
final OutlineInputBorder authOutlineInputBorder = OutlineInputBorder(
  ...
  borderSide: const BorderSide(color: Color(0xFFFF7643), width: 2.0),
);
